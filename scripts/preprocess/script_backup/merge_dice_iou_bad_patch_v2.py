...
qscore_dir = '/local_storage/baos1/ISBI24/Done/Q_SCORE/bad_patch/min/'

dice_min = np.load(f'{qscore_dir}/DICE/{img_prefix}_bad_patch_selection_DICE_min.npy')
iou_min = np.load(f'{qscore_dir}/IOU/{img_prefix}_bad_patch_selection_IOU_min.npy')
