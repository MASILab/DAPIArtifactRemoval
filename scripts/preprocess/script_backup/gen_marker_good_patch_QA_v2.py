...
df =pd.read_csv('/local_storage/baos1/ISBI24//Done/Q_SCORE/good_patch/min/post_manual_QA_v2.csv')
...
for index, row in df.iterrows():
    ...
    for marker in marker_list:
        ...
        img_list = []
        img_list.append(dapi_crop)
        img_list.append(img_crop_masked)
        
        img_stack = np.hstack(img_list)
    
        cv2.imwrite(f'/local_storage/baos1/ISBI24/Done/QA_1024/AFRemoved/{tis_name}_{marker}_{h}_{w}_masked.png', img_stack)
