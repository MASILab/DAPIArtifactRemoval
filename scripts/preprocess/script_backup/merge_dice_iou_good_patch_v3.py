...
dice_min = np.load(f'{qscore_dir}/DICE/{img_prefix}_good_patch_selection_DICE.npy')
iou_min = np.load(f'{qscore_dir}/IOU/{img_prefix}_good_patch_selection_IOU.npy')
...
sorted_df_subset.to_csv(f'{qscore_dir}/{img_prefix}_good_patch_selection_final_no_min.csv')
