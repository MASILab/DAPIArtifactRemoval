...
qscore_dir = '/local_storage/baos1/ISBI24//Done/Q_SCORE/DAPI/'

dice_min = np.load(f'{qscore_dir}/{img_prefix}_good_patch_selection_DICE.npy')
iou_min = np.load(f'{qscore_dir}/{img_prefix}_good_patch_selection_IOU.npy')
...
sorted_df_subset.to_csv(f'{qscore_dir}/{img_prefix}_good_patch_selection_final.csv')
